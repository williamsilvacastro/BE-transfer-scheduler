...
class TaxaServiceTest {
    ...
    void calcularTaxa_MesmoDia_DeveRetornarTaxaCorreta() {
        ...
        assertEquals(0, new BigDecimal("5.50").compareTo(taxa.setScale(2, RoundingMode.HALF_UP)));
    }
    ...
    void calcularTaxa_Entre1e10Dias_DeveRetornarTaxaFixa() {
        // Arrange
        LocalDateTime hoje = LocalDateTime.now();
        LocalDateTime dataTransferencia = hoje.plusDays(5);
        BigDecimal valor = new BigDecimal("100.00");
        ...
        // Assert
        // Taxa fixa de 12.00
        assertEquals(0, new BigDecimal("12.00").compareTo(taxa.setScale(2,  RoundingMode.HALF_UP)));
    }
    ...
    void calcularTaxa_Entre11e20Dias_DeveRetornarTaxaPercentual() {
        // Arrange
        LocalDateTime hoje = LocalDateTime.now();
        LocalDateTime dataTransferencia = hoje.plusDays(15);
        BigDecimal valor = new BigDecimal("100.00");
        ...
        // Assert
        // 100 * 0.082 = 8.20
        assertEquals(0, new BigDecimal("8.20").compareTo(taxa.setScale(2, RoundingMode.HALF_UP)));
    }
    ...
    void calcularTaxa_Entre21e30Dias_DeveRetornarTaxaPercentual() {
        // Arrange
        LocalDateTime hoje = LocalDateTime.now();
        LocalDateTime dataTransferencia = hoje.plusDays(25);
        BigDecimal valor = new BigDecimal("100.00");
        ...
        // Assert
        // 100 * 0.069 = 6.90
        assertEquals(0, new BigDecimal("6.90").compareTo(taxa.setScale(2, RoundingMode.HALF_UP)));
    }
    ...
    void calcularTaxa_Entre31e40Dias_DeveRetornarTaxaPercentual() {
        // Arrange
        LocalDateTime hoje = LocalDateTime.now();
        LocalDateTime dataTransferencia = hoje.plusDays(35);
        BigDecimal valor = new BigDecimal("100.00");
        ...
        // Assert
        // 100 * 0.047 = 4.70
        assertEquals(0, new BigDecimal("4.70").compareTo(taxa.setScale(2, RoundingMode.HALF_UP)));
    }
    ...
    void calcularTaxa_Entre41e50Dias_DeveRetornarTaxaPercentual() {
        // Arrange
        LocalDateTime hoje = LocalDateTime.now();
        LocalDateTime dataTransferencia = hoje.plusDays(45);
        BigDecimal valor = new BigDecimal("100.00");
        ...
        // Assert
        // 100 * 0.017 = 1.70
        assertEquals(0, new BigDecimal("1.70").compareTo(taxa.setScale(2, RoundingMode.HALF_UP)));
    }
    ...
    void calcularTaxa_DataTransferenciaMenorQueDataAgendamento_DeveLancarExcecao() {
        // Arrange
        LocalDateTime hoje = LocalDateTime.now();
        LocalDateTime dataTransferencia = hoje.minusDays(1);
        BigDecimal valor = new BigDecimal("100.00");
    ...
    void calcularTaxa_DiferencaMaiorQue50Dias_DeveLancarExcecao() {
        // Arrange
        LocalDateTime hoje = LocalDateTime.now();
        LocalDateTime dataTransferencia = hoje.plusDays(51);
        BigDecimal valor = new BigDecimal("100.00");
